...
public class Hotel {
    ...
    private final List<Boeking> alleBoekingen = new ArrayList<Boeking>();
    private final List<KamerType> alleKamerTypen = new ArrayList<KamerType>();
    ...
    public Boeking voegBoekingToe(LocalDate van, LocalDate tot, String naam, String adres, KamerType type) throws Exception {
        ...
        System.out.println("Kamer Geboekt");
        return boeking;
    }
